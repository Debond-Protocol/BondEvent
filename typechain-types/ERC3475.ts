...
export interface ERC3475Interface extends utils.Interface {
  functions: {
...
export interface ERC3475 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3475Interface;
  ...
  functions: {
    ...
    classMetadata(
      metadataId: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
